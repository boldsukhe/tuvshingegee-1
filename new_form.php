...
<form action="save_new_form.php" method="POST">
    ...
    <tr>
        ...
        <td><input type="text" name="uuriin_machine" class="table-input"></td>
        <td><input type="text" name="tuslan_machine" class="table-input"></td>
        <td><input type="text" name="turees_machine" class="table-input"></td>
    </tr>
    <tr>
    ...
    document.getElementById("project_group_number").addEventListener("change", function () {
        ...
        if (ded_buleg !== "") {
            ...
            .then(data => {
                ...
                buleg_utga.value = data.utga || "No description";
                buleg_utga_display.textContent = data.utga || "No description";
